...
#' \item{"nr_NA": number of values in imp_ds that are NA (not imputed)}
...
#' @param tolerance numeric, numeric differences smaller than tolerance are
#' treated as zero/equal
#'
